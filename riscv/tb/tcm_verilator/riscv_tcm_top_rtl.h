...
private:
    ...
    sc_signal <uint32_t> m_axi_t_awaddr_in;
    sc_signal <uint32_t> m_axi_t_awid_in;
    sc_signal <uint32_t> m_axi_t_awlen_in;
    sc_signal <uint32_t> m_axi_t_awburst_in;
    sc_signal <bool> m_axi_t_wvalid_in;
    sc_signal <uint32_t> m_axi_t_wdata_in;
    sc_signal <uint32_t> m_axi_t_wstrb_in;
    sc_signal <bool> m_axi_t_wlast_in;
    sc_signal <bool> m_axi_t_bready_in;
    sc_signal <bool> m_axi_t_arvalid_in;
    sc_signal <uint32_t> m_axi_t_araddr_in;
    sc_signal <uint32_t> m_axi_t_arid_in;
    sc_signal <uint32_t> m_axi_t_arlen_in;
    sc_signal <uint32_t> m_axi_t_arburst_in;
    sc_signal <bool> m_axi_t_rready_in;
    sc_signal <uint32_t> m_intr_in;
    ...
    sc_signal <uint32_t> m_axi_t_bresp_out;
    sc_signal <uint32_t> m_axi_t_bid_out;
    sc_signal <bool> m_axi_t_arready_out;
    sc_signal <bool> m_axi_t_rvalid_out;
    sc_signal <uint32_t> m_axi_t_rdata_out;
    sc_signal <uint32_t> m_axi_t_rresp_out;
